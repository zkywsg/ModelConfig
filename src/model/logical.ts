...
import type { EnvironmentConfig, LogicalModelResolution } from '../types.ts';

export function resolveLogicalModel(envConfig: EnvironmentConfig, modelName: string): LogicalModelResolution {
  ...
  return {
    ...
    strategy: 'priority',
    candidates: [...logicalModel.candidates]
  };
}
